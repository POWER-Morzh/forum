...
//-- add
	if($post_data['enable_city_filter'] && empty($_POST['city'])) {
		$error[] = 'Bitte whlen Sie die Stadt.';
	}
...
//-- mod : Filter by Cities ------------------------------------------------------------
//-- add
			if($post_data['enable_city_filter']) {
				$data['city_id'] = $_POST['city'];
				$data['enable_city_filter'] = $post_data['enable_city_filter'];
			}
//-- fin mod : Filter by Cities --------------------------------------------------------
